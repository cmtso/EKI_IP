...
switch Pr.n_fields
    case 4
        K(1).mean.lim=[log(1/300),log(1/0.5)];
        K(2).mean.lim=[log(1/300),log(1/0.5)];
        K(3).mean.lim=[log(1/300),log(1/0.5)];
        K(4).mean.lim=[log(1/300),log(1/0.5)]; 
        ...
        K(4).per.nu = 1.5; K(4).per.sigma =1.0; %%constant for now
    case 3
        K(1).mean.lim=[log(1/50),log(1/0.5)]; 
        K(2).mean.lim=[log(1/180),log(1/80)]; %%%THIS IS THE BACKGROUND SIGMA (this is the value the conductivity takes outside zone 1).
    ...
    case 2
        K(1).mean.lim=[log(1/300),log(1/80)]; %%%THIS IS THE BACKGROUND SIGMA (this is the value the conductivity takes outside zone 1).
        K(2).mean.lim=[log(1/50),log(1/0.5)]; % iron, very conductive! 
