...
switch Pr.n_fields
    ...
    case 3
        K(1).mean.lim=[-25,-19]; 
        K(2).mean.lim=[-17,-13]; %%%THIS IS THE BACKGROUND SIGMA (this is the value the conductivity takes outside zone 1).
        K(3).mean.lim=[-12,-5]; 
        K(1).per.nu = 1.5; K(1).per.sigma =1.0;
        K(2).per.nu = 1.5; K(2).per.sigma =1.0; %%constant for now
        K(3).per.nu = 1.5; K(3).per.sigma =1.0; %%constant for now
    case 2
        K(1).mean.lim=[-7,-1]; %%%THIS IS THE BACKGROUND SIGMA (this is the value the conductivity takes outside zone 1).
        K(2).mean.lim=[-20,-12]; 
