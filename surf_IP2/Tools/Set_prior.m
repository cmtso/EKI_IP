...
switch Pr.n_fields
    case 3
        K(1).mean.lim=[log(1/1000),log(1/250)]; 
        K(2).mean.lim=[log(1/250),log(1/150)]; %%%THIS IS THE BACKGROUND SIGMA (this is the value the conductivity takes outside zone 1).
    ...
    case 2
        K(1).mean.lim=[log(1/150),log(1/70)]; %%%THIS IS THE BACKGROUND SIGMA (this is the value the conductivity takes outside zone 1).
        K(2).mean.lim=[log(1/30),log(1/5)]; 
