...
switch Pr.n_fields
    case 3
        K(1).mean.lim=[log(1/10),log(1/0.5)]; 
        K(2).mean.lim=[log(1/300),log(1/100)]; %%%THIS IS THE BACKGROUND SIGMA (this is the value the conductivity takes outside zone 1).
        K(3).mean.lim=[log(1/80),log(1/20)]; 
